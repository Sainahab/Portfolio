...
try {
    ...
    $mail->Host = 'mail1.netim.hosting';  // Specify main and backup SMTP servers
    $mail->SMTPAuth = true;                               // Enable SMTP authentication
    $mail->Username = 'donot-reply@signworks.ma';                 // SMTP username
    $mail->Password = 'Donot123@';                           // SMTP password
    $mail->SMTPSecure = 'ssl';                           // Enable TLS encryption, `ssl` also accepted
    $mail->Port = 465;                                    // TCP port to connect to

    //Recipients
    $mail->setFrom('Donot-reply@signworks.ma', 'Portfolio Contact Form');
